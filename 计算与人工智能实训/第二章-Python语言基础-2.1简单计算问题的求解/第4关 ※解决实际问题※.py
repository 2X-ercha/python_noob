...
for (P, N, r) in [(300000,10,6.5), (300000,20,6.5),(300000,30,6.5)]:
    # 请在下面编写代码
    r2,N2=r/1200,N*12
    payPerMonth=P*r2*(1+r2)**N2/((1+r2)**N2-1)
    # 请不要修改下面的代码
    print_(payPerMonth)
...
for (x1,y1,x2,y2) in [(48.87,-2.33,37.8,-122.4),(40.89,116.50,37.8,-122.4),(40.89,116.50,48.87,-2.33)]:
    # 请在下面编写代码
    dist=R*math.degrees(math.acos(math.sin(math.radians(x1))*math.sin(math.radians(x2))+math.cos(math.radians(x1))*math.cos(math.radians(x2))*math.cos(math.radians(y1-y2))))
    # 请不要修改下面的代码
    print_(dist)
